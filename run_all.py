...
import random
import numpy as np
from exp.Main_for_7datasetV3 import Exp_Main
...
parser.add_argument('--model',  default='STMixer', help='STMixer,patchtst,Dlinear,Nlinear,Linear')   
# data loader
parser.add_argument('--checkpoints', type=str, default='./checkpoints/', help='location of model checkpoints')

parser.add_argument('--data_path', type=str, default=r'.\all_six_datasets\traffic\traffic.csv', help='data_path')###
parser.add_argument('--features', type=str, default='M', help='features')
parser.add_argument('--data_set', type=str, default='all', help='all') 
...
# model define 
parser.add_argument('--input_size', type=int, default=1, help='x size')  ###
parser.add_argument('--mark_size', type=int, default=8, help='x_mark size') ###
...
parser.add_argument('--p',  type=int, default=2, help='1,2')
...
parser.add_argument('--report_freq', type=int, default=20, help='训练几轮才进行一次验证和测试')
parser.add_argument('--patience', type=int, default=10, help='early stopping patience')
parser.add_argument('--learning_rate', type=float, default=0.001, help='optimizer learning rate') 
parser.add_argument('--loss', type=str, default='mae', help='loss function:mse,mae')
...
#对于基线模型，此处应该保持decomp_len=seq_len
if args.model=='Dlinear':    
    args.decomp_len = args.seq_len
